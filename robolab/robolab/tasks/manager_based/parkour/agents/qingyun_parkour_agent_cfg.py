...
from robolab.tasks.manager_based.parkour.mdp.symmetry import qingyun


@configclass
class QingYunPpoEncoderMoEActorCriticCfg:
...
class QingYunParkourAmpRunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    policy = QingYunPpoEncoderMoEActorCriticCfg()
    algorithm = RslRlPpoAmpAlgorithmCfg(
        ...
        symmetry_cfg=RslRlSymmetryCfg(
            ...
            data_augmentation_func=qingyun.compute_symmetric_states,
        ),
        amp_cfg=RslRlAmpCfg(
